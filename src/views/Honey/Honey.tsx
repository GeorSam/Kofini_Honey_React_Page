import Jar from "./../../assets/Adobe Express - file.jpg";
    ...
    <div>
      <div className="flex text-center items-center justify-center bg-linear-to-t from-yellow-50/1 to-yellow-200/100">
        <img
          src={Jar}
          alt=""
          className="h-[350px] w-[350px] object-cover mt-40 sm:h-[450px] sm:w-[450px] rounded-full ml-15 border-amber-300 border-8 transition-shadow duration-300 cursor-pointer hover:shadow-xl hover:shadow-yellow-700"
          style={{
